...
try:
    def main():
        obj=Restaurant("SRB family")
        print(f"!!  Welcome To {obj.restro_name} Restaurant  !!\n")
        print("!!----------------------------------------------------------")
        print("\nHellow sir Thank you for the giving these opportunities\
        \nI have made 'My First python  Project @ PYTHON my career' :) wow it's amazing!!!\
        \nSir ! What you want to eat in my  SRB Restaurant ? Its a party from my side :)")
        print("\n-----------------------------------------------------------!!\n")
